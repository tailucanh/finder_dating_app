...
class FullTopUserRecentPage extends StatefulWidget {
  const FullTopUserRecentPage({
    super.key,
  ...
  @override
  State<FullTopUserRecentPage> createState() => _FullTopUserRecentPageState();
}

class _FullTopUserRecentPageState extends State<FullTopUserRecentPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PrimaryAppBar(
          context: context,
          text: S().topUserRecentActivityTitle,
          center: true,
      ),
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 15),
                child: Text(S().topUserRecentActivityContent,
